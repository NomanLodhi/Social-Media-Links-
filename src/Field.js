...
export default function Field() {
  ...
  <div className="container d-flex align-item-center justify-content-center p-5 my-5 ">
    <div className="card bg-card border border-light text-light border-3 py-4 ">
      ...
      <div className="rounded-pill btn btn-outline-light w-75 mx-auto my-3 btn-social fw-bold fs-5 "><a href="https://github.com/NomanLodhi" target='main' className=' text-decoration-none w-100'><i class="bi bi-github mx-2"></i>Github</a></div>
    </div>
  </div>
  </>
  )
